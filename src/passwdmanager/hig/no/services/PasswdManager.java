...
import passwdmanager.hig.no.certificates.TerminalCVCertificateDirectory;
import passwdmanager.hig.no.lds.DG_14_FILE;
import passwdmanager.hig.no.lds.DG_15_FILE;
...
public class PasswdManager {
	 ...
	 * @throws CardServiceException on problems
	 */
	public PasswdManager(BasicService service) throws IOException,
	 ...
	 *
	 * @param service the card service
	 * @param documentNumber the document number to use for EAC, if not provided
	 * (null) the one from DG1 will be used.
	 * @throws IOException on problems
	 * @throws CardServiceException on problems
	 */
	public PasswdManager(BasicService service, String documentNumber)
	 ...
	 * @throws IOException on problems
	 */
	public PasswdManager(File file) throws IOException {
		this(file, true, null);
	}
	 ...
	 *
	 * @param file the ZIP file
	 * @param allowInconsistent whether the ZIP file can be incomplete (the
	 * missing data will be ignored)
	 * @param docSigningPrivateKey private key to sign the data on the (SOD),
	 * can be null
	 * @throws IOException on problems
	 */
	public PasswdManager(File file, boolean allowInconsistent, DocumentSigner signer) throws IOException {
		this.signer = signer;
	...
	/**
	 * Constructs an alomost empty CARD with just the COM and SOD files.
	 *
	 * @throws GeneralSecurityException when ciphers or similar are not
	 * available.
	 */
	public PasswdManager() throws GeneralSecurityException {
	...
	/**
	 * Puts/replaces the given file in this Passwd Manager. Triggers all
	...
	/**
	 * Puts/replaces the given file in this card. Triggers all necessary changes
	 * (COM/SOD file update, resigning, etc.)
	 *
	 * @param fid the FID of the file
	 * @param bytes the file contents
	 * @param eacProtection whether the file should be EAC protected
	 */
	...
	/**
	 * Removes the given file in this card. Triggers all necessary changes
	 * (COM/SOD file update, resigning, etc.)
	 *
	 * @param fid the FID of the file to be removed
	 */
	...
	/**
	 * Sets the current document signer. Triggers all necessary changes (COM/SOD
	 * file update, resigning, etc.)
	 *
	 * @param signer the document signer
	 */
	 ...
	 *
	 * @param newCertificate the new document signing certificate
	 */
	 ...
	 *
	 * @param cert the new EAC CVCA certificate
	 */
	 ...
	 * (COM/SOD file update, resigning, etc.)
	 *
	 * @param keyPair the EAC key pair
	 */
	...
	/**
	 *
	 * @return whether has EAC support
	 */
	...
	/**
	 *
	 * @return total number of files read in so far from the card (card).
	 */
	...
	/**
	 * Uploads this passwdmanager to the card using the provided Personalization
	 * service.
	 *
	 * @param persoService the passwdmanager personalization service
	 ...
	 *
	 * @param persoService the passwdmanager personalization service
	 * @param keySeed the key seed string (SAI) to use
	 * @throws CardServiceException on errors
	 */
