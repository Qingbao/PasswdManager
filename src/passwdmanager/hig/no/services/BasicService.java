...
public class BasicService extends ApduService {
	 ...
	 * 
	 * @param publicKey
	 *            the public key to use (usually read from the card, DG15)
	 * 
	...
	/**
	 * Performs the Terminal Authentication (TA) part of the EAC protocol with
	 * the card. In short: (a) feed the sequence of terminal
	 * certificates to the card for verification. (b) get a challenge from the
	 * card, sign it with terminal private key, send back to the card for
	 * verification.
	 * 
