...
public class BasicService extends ApduService {
	 ...
	 * the card. In short: (a) feed the sequence of terminal certificates to the
	 * card for verification. (b) get a challenge from the card, sign it with
	 * terminal private key, send back to the card for verification.
	 *
