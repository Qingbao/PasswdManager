...
public class DG_COM extends DataGroups {
	 ...
	 *
	 * @param majorVersion an integer (=1)
	 * @param releaseVersion an integer
	 * @param tagList a list of data group tags
	 * @param sois array with security object indicators
	 *
	 ...
	 * @param majorVersion an integer (=1)
	 * @param releaseVersion an integer
	 * @param tagList a list of ISO18013 data group tags
	 */
	public DG_COM(int majorVersion, int releaseVersion, List<Integer> tagList) {
	 ...
	 * <code>in</code>.
	 *
	 * @param in should contain a TLV object with appropriate tag and contents
	 *
	...
	/**
	 * Inserts a tag in a proper place if not already present. It is the clients
	 * responsibility to make sure the tags are sorted according to the DG
	 * number.
	 *
	 * @param tag
	 */
