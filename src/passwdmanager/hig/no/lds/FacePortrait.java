...
/**
 * Encapsulates a face portrait stored on the card. Stores raw image data, the
 * mime type of the image, and the time stamp.
 *
 *
 */
public class FacePortrait {
	 ...
	 *
	 * @param portraitContents raw portrait contents
	 * @param mimeType the mime type of the image
	 * @param time the time stamp string
	 */
	 ...
	 *
	 * @param in the input stream with the data to be decoded.
