...
public class DG_SOD extends FileStructure {
	 ...
	 * @param digestEncryptionAlgorithm a digest encryption algorithm, such as
	 * "SHA256withRSA"
	 * @param dataGroupHashes maps datagroupnumbers (1 to 16) to hashes of the
	 * data groups
	 * @param encryptedDigest the signature
	 * @param docSigningCertificate the document signing certificate
	 *
	 * @throws NoSuchAlgorithmException if either of the algorithm parameters is
	 * not recognized
	 * @throws CertificateException if the document signing certificate cannot
	 * be used
	 */
	 ...
	 * details.
	 *
	 * @param docSigningCert the certificate to use (should be X509 certificate)
	 *
