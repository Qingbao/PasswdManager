package passwdmanager.hig.no.certificates;
...
/**
 * A class for generating card verifiable certificates Uses the modified
 * org.ejbca.cvc library. The files are written to the predefined files, see
 * below.
 *
 *
 */
		...
		try {
			...
			CVCertificate caCvc = CertificateGenerator.createCertificate(
					...
					"SHA1WithRSA", caRef, holderRef, new AuthorizationRole(
							...
							AccessRight.DG2 | AccessRight.DG3), validFrom,
					validTo, "BC");
