package passwdmanager.hig.no.utils;
...
public class Files {
	 ...
	 *
	 * @param file the file with the key
	 ...
	 *
	 * @param file the file with the certificate
	...
	/**
	 * Writes raw data to a file. NOTE: overwrites existing files without
	 * asking.
	 *
	 * @param path path to the file to be written (no overwrite checks!)
	 ...
	 * asking.
	 *
	 * @param file the file object to be written (no overwrite checks!)
	 * @param data raw data to be written
	 * @throws IOException if something goes wrong
	 */
