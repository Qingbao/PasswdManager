package passwdmanager.hig.no.events;

import java.util.EventObject;

import passwdmanager.hig.no.services.BasicService;
import passwdmanager.hig.no.services.SecureMessagingWrapper;
...
public class BACEvent extends EventObject {
	...
	/**
	 * Gets the random nonce sent by the ICC during this BAP protocol run.
	 *
