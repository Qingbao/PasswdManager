...
/**
 * A panel to enter and display data (DG1, DG3) in an organised fashion.
 *
 *
 */
public class DataPanel extends JPanel {
	...
	/**
	 *
	 * @param fields an array of filed specifications
	 * @param editable whether the fields should be editable by the user
	 */
	...
	/**
	 *
	 * @return the map of optional group check boxes. This is needed in the
	 * parant frame.
	 */
