...
/**
 * A class reflect the format of a field for entering data. 
 * The set of characters can be limited (e.g. only letters or
 * digits, the minimum and maximum length). For int fields also a minimum and
...
public class FieldFormat {
     ...
     * 
     * @param characters
     *            a mask with allowed characters
     * @param fixedLength
     *            the length of the field (fixed=min=max)
     */
     ...
     * 
     * @param characters
     *            a mask with allowed characters (should be DIGITS)
     * @param fixedLength
     *            the length of the field (fixed=min=max)
     * @param minValue
     *            min value
     ...
     * @param minValue
     *            min value of the (int) field
     * @param maxValue
     *            max value of the (int) field
     */
    public FieldFormat(int characters, int minLength, int maxLength,
